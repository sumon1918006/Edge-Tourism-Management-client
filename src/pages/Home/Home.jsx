  ...
  return (
    <div>
      ...
      <div className="mx-auto text-center mt-10 bg-white  mb-10 lg:mt- lg:mb-16">
        ...
        South Asia tourist spots feature diverse landscapes, ancient ruins, vibrant cultures, and <br />culinary delights, promising memorable experiences for travelers.
        </p>
        </div>
