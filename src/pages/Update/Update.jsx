...
const Update = () => {
  ...
  const handleAddSpot = (event) => {
    ...
    fetch(
      `https://b9-a10-tourism-management-server.vercel.app/addspot/${_id}`,
      {
        method: "PUT",
        headers: {
    ...
    <div className="pb-14">
      ...
      >
        <h1 className="flex items-center gap-3 text-2xl pb-2 font-bold border-b border-[#958d8d]">
          <FaMapLocationDot /> <span>Tourists Spot Information</span>
        </h1>
        ...
        <div className="lg:flex gap-5 mt-4">
          <div className="w-full">
            ...
            <input
              ...
              className="p-1 w-full border input-info rounded-lg"
            />
          </div>
          <div className="w-full">
        ...
        <h1 className="flex mt-8 items-center gap-3 text-2xl pb-2 font-bold border-b border-[#958d8d]">
          <FaUserCircle /> <span>User Information</span>
        </h1>
