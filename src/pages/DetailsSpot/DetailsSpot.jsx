...
const DetailsSpot = () => {
  ...
  return (
    <div className="border rounded lg:mx-20 mt-10 mb-32 lg:p-8 p-4 bg-slate-200 grid w-full grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <section className="bg-white rounded-md px-12 pb-3 pt-6">
        ...
        <p className="text-[16px] lg:text-xl font-medium py-4">Country : {subcategory_name}</p>

        <div className="text-[16px] lg:text-xl  font-medium pb-6 pt-3 border-y-2 space-y-3">
        ...
        <div className="py-5 text-[16px] lg:text-xl  ">
          <p className="text-xl  font-bold pb-2">Description :</p>
          {short_description}
        </div>

        {(detailSopt.user_name && detailSopt.user_email) && (
          <div className="text-[16px] lg:text-xl  font-medium pb-4 pt-4 border-t-2 space-y-3">
